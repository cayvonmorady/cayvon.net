        ...
        <div className="relative overflow-hidden">
          ...
          <header className="relative z-10">
            <div className="hero-safe-top relative mx-auto w-full max-w-5xl px-6 pb-6">
              ...
              >
                <div className="hero-bloom-primary absolute -left-20 -top-16 h-64 w-64 rounded-full bg-[radial-gradient(circle,var(--bloom-accent),transparent_72%)] opacity-80 blur-2xl sm:-left-24 sm:top-2 sm:h-[22rem] sm:w-[22rem] sm:opacity-90 sm:blur-3xl xl:-left-14 xl:top-8 xl:h-[26rem] xl:w-[26rem]" />
